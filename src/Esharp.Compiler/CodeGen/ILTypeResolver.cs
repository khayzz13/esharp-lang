...
public sealed class ILTypeResolver : IMetadataResolver
{
    ...
    TypeReference ResolvePrimitive(string name) => name switch
    {
        ...
        "decimal" => _module.ImportReference(typeof(decimal)),
        "nint" => _module.ImportReference(typeof(nint)),
        "nuint" => _module.ImportReference(typeof(nuint)),
        ...
        "Guid" => _module.ImportReference(typeof(Guid)),
        "DateTime" => _module.ImportReference(typeof(DateTime)),
        "DateTimeOffset" => _module.ImportReference(typeof(DateTimeOffset)),
        "TimeSpan" => _module.ImportReference(typeof(TimeSpan)),
